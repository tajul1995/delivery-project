      ...
      {errors.password?.type === "required" && (
        <p className="text-red-500 font-bold">password  is required</p>
          ...
          <div className=" flex flex-col gap-3 ">
            ...
            <p className="uppercase font-bold text-green-200"> Dont have an account ?<Link to='/register' className="uppercase font-bold text-green-200 underline ml-1">Register</Link></p>
